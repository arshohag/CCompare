...
export type Action =
  ...
  | { type: 'COINS_REQUESTING' }
  | { type: 'COINS_SUCCESS', data: Array<Object> }
  | { type: 'COINS_FAILURE', err: any }
  | { type: 'COINST_REQUESTING' };
  | { type: 'COINST_SUCCESS', time_data: Array<Object> };
  | { type: 'COINST_FAILURE', err: any };
  | { type: 'HOME_REQUESTING' }
  | { type: 'HOME_SUCCESS', data: Array<Object> }
