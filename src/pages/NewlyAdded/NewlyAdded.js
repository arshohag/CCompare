...
import { NewlyAddedComp } from '../../components'
type Props = { home: HomeType, fetchHomeData: () => void };

// Export this for unit testing more easily
export class NewlyAdded extends Component<Props> {
  componentDidMount() {
  ...
  renderHome = () => {
    ...
    if (
      ...
      return <NewlyAddedComp  data={home.list}/>;
    }
  };
...
export default compose(withRouter, connector)(NewlyAdded);
