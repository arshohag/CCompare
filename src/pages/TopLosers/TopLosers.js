...
import { TopLosersComp } from '../../components'
type Props = { home: HomeType, fetchHomeData: () => void };

// Export this for unit testing more easily
export class TopLosers extends Component<Props> {
  componentDidMount() {
  ...
  renderHome = () => {
    ...
    if (
      ...
      return <TopLosersComp  data={home.list}/>;
    }
  };
...
export default compose(withRouter, connector)(TopLosers);
